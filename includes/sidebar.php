    <div class="sidebar-menu">
                    <header class="logo1">
                      <span style="color:#000; font-size:20px; font-weight:bold">H_H</span>
                        ...
                        <div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
                                    ...
                                    <li id="menu-academico" ><a href="#"><i class="lnr lnr-layers"></i> <span>Reports</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                         <ul id="menu-academico-sub" >
                                            <li id="menu-academico-avaliacoes" ><a href="enquiry-betdates-reports.php">Enquiry Between Reports</a></li>
                                            <li id="menu-academico-boletim" ><a href="booking-betdates-reports.php">Booking Between Reports</a></li>
                                          </ul>
                                     </li>
                                  </ul>
                                </div>
